...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">query-jobs documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-ccfc9c7902c3a56045ed188d3e5b80bd"' : 'data-target="#xs-components-links-module-AppModule-ccfc9c7902c3a56045ed188d3e5b80bd"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-ccfc9c7902c3a56045ed188d3e5b80bd"' :
                                            'id="xs-components-links-module-AppModule-ccfc9c7902c3a56045ed188d3e5b80bd"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CategoriaDeleteComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >CategoriaDeleteComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/CategoriaEditeComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >CategoriaEditeComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PostagensComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >PostagensComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ProdDeleteComponent.html" data-type="entity-link" >ProdDeleteComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/ProdEditComponent.html" data-type="entity-link" >ProdEditComponent</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
